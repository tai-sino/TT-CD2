...
| 2 | Import SV & Phân công GVHD | ▶ In Progress | 1/3 done |
...
- [Phase 02]: Dung phpspreadsheet truc tiep (IOFactory::load) thay vi maatwebsite/excel
- [Phase 02]: Import SV bat buoc ky_lvtn_id (KY-03), filter SV theo GVHD dung whereHas (SV-03)

## Next Action

Tiep tuc Phase 02: Plan 02-00 (test infra) va 02-02 (FE pages)
...
---
*Last session: 2026-04-07 — Completed 02-01-PLAN.md (BE API SV/GV/Ky)*
