...
const menuConfig = {
  admin: [
    ...
    { label: 'Phân công GVHD', path: '/admin/phan-cong-gvhd', icon: HiOutlineUserGroup },
    { label: 'Đề tài', path: '/admin/de-tai', icon: HiOutlineDocumentText },
    { label: 'Phân công GVPB', path: '/admin/phan-cong-gvpb', icon: HiOutlineClipboardDocumentCheck },
