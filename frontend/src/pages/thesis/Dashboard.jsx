...
export default function Dashboard() {
  ...
  // Thống kê
  const [stats, setStats] = useState({ total: 0, students: 0, finished: 0 });
  ...
  return (
    <div className="dashboard-page">
      ...
      <div style={{display:'flex',gap: '10px',marginBottom: '24px'}}>
        <div className="stat-card" style={{border: '1px solid #ddd', boxShadow: '2px 2px 4px rgba(0,0,0,0.1)'}}>
      ...
      <div className="toolbar" style={{marginBottom:16, display:'flex', alignItems:'center', gap:16}}>
