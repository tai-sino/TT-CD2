...
import { fetchCouncils } from "../../services/councilService";
                ...
                {councils.map((c) => (
                  <tr key={c.maHoiDong}>
                    ...
                    <td>
                      {c.members
                        ?.map(
                          (m) => m.tenGV + (m.vaiTro ? ` (${m.vaiTro})` : ""),
                        )
                        .join(", ")}
                    </td>
                    <td>
                      {theses
                        .filter((t) => t.maHoiDong === c.maHoiDong)
                        .map((t) => t.tenDeTai)
                        .join(", ")}
                    </td>
                  </tr>
                  ...
                  <tr key={t.maDeTai}>
                    ...
                    <td>
                      ...
                      >
                        ...
                        {councils.map((c) => (
                          <option key={c.maHoiDong} value={c.maHoiDong}>
                            {c.tenHoiDong}
                          </option>
                        ))}
                      </select>
                    ...
                    <td>
                      <button
                        ...
                        onClick={() => handleAssignTopic(t, t.maHoiDong)}
                        disabled={saving || !t.maHoiDong}
                      >
                        Lưu
                      </button>
                    </td>
